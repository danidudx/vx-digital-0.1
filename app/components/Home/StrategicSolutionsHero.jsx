...
const StrategicSolutionsHero = () => {
  ...
  const logos = [
    { src: "/logos/finance.png", alt: "Finance" },
    { src: "/logos/findr.png", alt: "Findr" },
    { src: "/logos/cosmic.png", alt: "Cosmic" },
    { src: "/logos/athexa.png", alt: "Athexa" },
    { src: "/logos/growing.png", alt: "Growing" },
    { src: "/logos/finance.png", alt: "Finance" },
    { src: "/logos/findr.png", alt: "Findr" },
    { src: "/logos/cosmic.png", alt: "Cosmic" },
  ];
    ...
    <>
      ...
      <div
        ...
        style={{
          ...
          backgroundImage: 'url("/backgrounds/homehero.png")',
